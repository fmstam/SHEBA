 ...
 * @author faroqal-tam
 */
public class WatershedBiasRemover extends PolynomialBiasRemover {
    ...
    public WatershedBiasRemover(int polynomialDegree, double downSamplingFactor, boolean saveIfieldImage, int smoothingWidth, boolean darkBackground, String outputpath){
